...
Route::get('/departments', App\Http\Livewire\SuppliumDepartments::class)->name('departments')->middleware('checkrole');
Route::get('/reports', App\Http\Livewire\SuppliumReport::class)->name('reports')->middleware('checkrole');
