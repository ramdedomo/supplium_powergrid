...
class Supply extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['id', 'supply_unit', 'supply_price', 'supply_type', 'supply_photo', 'supply_name', 'supply_stocks', 'supply_img', 'created_at', 'updated_at', 'supply_desc', 'supply_color'];
