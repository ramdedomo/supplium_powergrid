...
use App\Models\Requests as RequestsModel;
...
final class Requests extends PowerGridComponent
{
    use ActionButton;
    ...
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
           ...
           /** Example of custom column using a closure **/
            ->addColumn('created_at_lower', function (RequestsModel $model) {
